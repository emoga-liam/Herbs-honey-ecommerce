...
export default function LoginPage() {
  ...
  return (
    ...
    {showPhone && (
      <PhoneAuthModal
        onSuccess={() => { setShowPhone(false); navigate(redirect); }}
        ...
        <div className="bg-[#0f1e12] border border-amber-900/30 rounded-2xl p-8 shadow-2xl">
          <div className="grid grid-cols-2 gap-3 mb-6">
            <Button onClick={handleGoogle} variant="outline"
              className="w-full border-amber-700/50 text-amber-200 bg-transparent hover:bg-amber-900/20 gap-2 rounded-xl text-sm">
            ...
            <Button onClick={() => setShowPhone(true)} variant="outline"
              className="w-full border-amber-700/50 text-amber-200 bg-transparent hover:bg-amber-900/20 gap-2 rounded-xl text-sm">
