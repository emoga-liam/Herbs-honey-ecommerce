    ...
    <Layout>
      <div className="container max-w-3xl mx-auto px-4 py-16">
        <div className="mb-10">
          ...
          <h1 className="font-cormorant font-bold text-5xl text-foreground mb-3">Privacy Policy</h1>
          <p className="text-muted-foreground text-sm">Last updated: {s.privacyLastUpdated || "1 June 2025"}</p>
        </div>
