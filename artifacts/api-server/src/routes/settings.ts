...
const DEFAULTS: Record<string, string> = {
  ...
  companyTagline: "FFG Foods · Abuja, Nigeria",
  aboutText:
    "FFG Foods International General Services Limited is a proudly Nigerian company committed to delivering nature's best. Our herbs-infused honey sachets are crafted with premium natural ingredients and distributed fresh across Abuja.",
  ...
  footerText: "FFG Foods International General Services Limited. All rights reserved.",
  announcementBanner: "",
  ...
  termsS1: `By accessing and placing an order with FFG Foods International General Services Limited ("FFG Foods", "we", "us", or "our"), you confirm that you are in agreement with and bound by the terms and conditions contained herein. These terms apply to the entire website and any email or other type of communication between you and FFG Foods.`,
  termsS2: `FFG Foods sells herbs-infused honey sachets and boxes including Original, Hibiscus, Ginger Lemon, and Cinnamon Lemon flavors. All products are produced in Nigeria and are subject to availability. We reserve the right to discontinue any product at any time.\n\nProduct images are for illustration purposes. Actual packaging may vary slightly from what is shown on the website.`,
  ...
  termsS5: `We currently deliver within Abuja, Nigeria. Delivery timelines are estimates only and are not guaranteed. FFG Foods is not responsible for delays caused by circumstances beyond our control, including adverse weather conditions, traffic, or third-party logistics issues.\n\nRisk of loss and title for products passes to you upon delivery. If you are not available to receive your order, we will attempt to contact you to reschedule.`,
  termsS6: `If you receive a damaged or incorrect product, please contact us within 48 hours of delivery at info@ffgfoods.com or via WhatsApp. We will arrange a replacement or refund at our discretion.\n\nDue to the perishable and consumable nature of our products, we do not accept returns of opened or used products unless they are defective.`,
  ...
  termsS8: `All content on this website, including but not limited to text, graphics, logos, images, and software, is the property of FFG Foods International General Services Limited and is protected by Nigerian and international copyright laws. You may not reproduce, distribute, or create derivative works without our express written permission.`,
  termsS9: `To the fullest extent permitted by law, FFG Foods shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our website or products. Our total liability to you for any claim arising from these terms shall not exceed the amount you paid for the relevant order.`,
  ...
  termsS12: `If you have any questions about these Terms & Conditions, please contact us:\n\nCompany: FFG Foods International General Services Limited\nAddress: 68 Trade More Avenue, Lugbe, Abuja\nEmail: info@ffgfoods.com\nPhone: 09061602332`,
  // Privacy Policy
  privacyLastUpdated: "1 June 2025",
  privacyS1: `FFG Foods International General Services Limited ("FFG Foods", "we", "us", or "our") is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and place orders with us.`,
